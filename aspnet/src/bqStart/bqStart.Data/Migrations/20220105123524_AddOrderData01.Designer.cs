...
namespace bqStart.Data.Migrations
{
    ...
    [Migration("20220105123524_AddOrderData01")]
    partial class AddOrderData01
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BinaryQuest.Framework.Core.Data.SettingKey", b =>
                {
            ...
            modelBuilder.Entity("bqStart.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BinaryQuest.Framework.Core.Data.SettingKey", b =>
                {
                    b.HasOne("BinaryQuest.Framework.Core.Data.SystemSetting", "SystemSetting")
                        .WithMany("Settings")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("bqStart.Data.ApplicationUser", null)
                        .WithMany()
