...
{
    public partial class ExmData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExampleClasses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExampleClasses_Departments_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExampleClasses_DepartmentId",
