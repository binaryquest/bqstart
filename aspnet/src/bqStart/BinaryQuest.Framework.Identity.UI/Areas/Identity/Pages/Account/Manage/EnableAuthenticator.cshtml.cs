...
namespace BinaryQuest.Framework.Identity.UI.Web.Areas.Identity.Pages.Account.Manage
{
    ...
    public abstract class EnableAuthenticatorModel : PageModel
    {
    ...
    public class EnableAuthenticatorModel<TUser> : EnableAuthenticatorModel where TUser : BaseUser
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("BinaryQuest.Framework.Identity.UI.Web"),
